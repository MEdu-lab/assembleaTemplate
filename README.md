...
L'anno **{{data-anno}}**, il giorno **{{data-giorno}}** del mese di **{{data-mese}}**, alle ore **{{ora_inizio}}**, presso **{{luogo}}**, si è riunito il **{{tipo_riunione}}** dell'associazione **{{associazione}}**.
...
**Delibera:** Il {{tipo_riunione}} approva {{delibera_testo}}.
